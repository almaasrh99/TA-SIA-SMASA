					...
					<div class="card">                    
						<div class="body">
							<div class="btn-group btn-group-justified" role="group" aria-label="Justified button group">
								...
								<?php echo anchor('profil/profil_user', 'Data Diri', 'class="btn btn-lg bg-red waves-effect" role="button"'); ?>
								<?php echo anchor('profil/status_alumni', 'Status Alumni', 'class="btn btn-lg bg-amber waves-effect" role="button"'); ?>
							</div>
						</div>
					</div>
				</div>
