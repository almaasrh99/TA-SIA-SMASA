<div class="container">    
	<a class="line"><h4 class="margin h1" data-aos="zoom-out" data-aos-duration="500">Pencarian Data Alumni</h4></a>
		...
		<?php echo
            ...
            form_input('keyword', '', 'placeholder = "Cari data berdasarkan nisn, nama, tahun lulus, jenis kelamin" class = "form-control" data-aos="zoom-out" data-aos-duration="500" autocomplete="off"');
        ?>
		<center>
		...
		<?php if (isset($message)):
         echo  '<p data-aos="zoom-out" data-aos-duration="500">'.$message.'</p>';
            ...
            echo '
				...
				<table id="table" class="table table-hover table-mc-green" data-aos="zoom-out" data-aos-duration="500">					
