		...
		<?php if (isset($message)):
         echo  '<p data-aos="zoom-out" data-aos-duration="500">'.$message.'</p>';
            ...
            echo '
				...
				<table id="table" class="table table-hover table-striped table-bordered table-mc-green" data-aos="zoom-out" data-aos-duration="500">					
                <tr>
                    <td colspan="3"><b>Biodata diri</b></td>
                </tr>
                <tr>
                    <td>NISN</td>
                    <td>:</td>
