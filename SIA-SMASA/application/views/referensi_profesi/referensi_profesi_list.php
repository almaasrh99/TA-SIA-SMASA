                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><?php echo anchor(site_url('referensi_profesi/tambah_data'), 'Tambah Data'); ?></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="myTable">
									...
									<tbody>
										...
										<tr>
											...
											<?php echo anchor('referensi_profesi/delete/'.$hasil->id_profesi, '<button type="button" class="btn btn-danger btn-circle waves-effect waves-circle waves-float">
