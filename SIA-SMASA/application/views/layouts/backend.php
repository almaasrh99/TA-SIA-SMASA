...
<head>
    ...
    <meta name="author" content="Almaas Rozikin H">
    <!-- Favicon-->
    <link rel="icon" href="<?php echo base_url('assets'); ?>/smasa.png" type="image/x-icon">
...
<body class="theme-blue">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <img src="<?php echo base_url('assets'); ?>/logo_smasa.png" class="brand" width="60" height="60" alt=""> 
                    </div></a>
                <a class="navbar-brand" href="<?php echo base_url('home') ;?>"><?php echo $_app_name; ?> SMAN 1 Lumajang</a>
                <!-- <div class="logo-smasa">
                     <a href="<?php echo base_url('home') ;?>">
                    <img src="<?php echo base_url('assets'); ?>/logo_smasa.png" class="brand" width="60" height="60" alt=""> 
                    </div></a>
                <div class="title"><h3>Sistem Informasi Alumni SMASA</h3></div> -->
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?php echo base_url('assets/backend'); ?>/images/profile.png" style="width:80px;height:80px;margin-left:80px" alt="User" />
                </div>
    ...
    ?>
                    ...
                    <li <?php echo $segment1 == 'testimoni' ? 'class="active"' : ''; ?>>
                        <?php echo anchor('testimoni', '<i class="material-icons">sms</i><span>Testimoni</span>'); ?>
                    </li>
...
<?php
        ...
        ?>
                    ...
                    <!-- <li <?php echo $segment1 == 'galeri' ? 'class="active"' : ''; ?>>
                        <?php echo anchor('galeri/list_admin', '<i class="material-icons">insert_photo</i><span>Galeri</span>'); ?>
                    </li> -->
                    <li <?php echo $segment1 == 'testimoni' ? 'class="active"' : ''; ?>>
                    ...
                    <li <?php echo $segment1 == 'rekapitulasi' ? 'class="active"' : ''; ?>>
                        <?php echo anchor('rekapitulasi', '<i class="material-icons">contact_page</i><span>Rekapitulasi Data</span>'); ?>
                    </li>
        ...
        ?>
                    <li <?php echo $uri_string == 'auth/logout' ? 'class="active"' : ''; ?>>
                        <?php echo anchor('auth/logout', '<i class="material-icons">logout</i><span>'.$this->lang->line('logout_heading').'</span>'); ?>
                    </li> 
                    <?php
    }?>   
                </ul>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; <?php echo date('Y'); ?> <a href="javascript:void(0);">Almaas Rozikin</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0
                </div>
