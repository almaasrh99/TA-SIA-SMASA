<html>
	<head>
        ...
        <meta name="author" content="Almaas Rozikin ">
  		...
  		<div class="navbar-fixed">
			<nav>
		    	<div class="nav-wrapper teal">
                    ...
                    <img src="<?php echo base_url('assets'); ?>/logo_smasa.png" class="brand" width="60" height="60" alt=""> </a>
                    </div>
		    		<div class="container">
			      		<ul id="nav-mobile" class="hide-on-med-and-down">
                            <li><?php echo anchor('main/lulusan','<i class="fa fa-fw fa-users"></i> Data Alumni'); ?></li>
					        <li><?php echo anchor('main/loker','<i class="fa fa-fw fa-briefcase"></i> Lowongan Kerja'); ?></li>
                            <li><?php echo anchor('main/kegiatan', '<i class="fa fa-fw fa-bell"></i> Event'); ?></li>                            
					        <li><?php echo anchor('main/about', '<i class="fa fa-exclamation-circle"></i> Tentang Web'); ?></li>
		      			</ul>
                         
		      			<ul id="nav-mobile" class="right hide-on-med-and-down">	
                                <li id="date"></li>
                                <li id="time"></li>
                                <li class="fa fa-fw fa-calendar fa-3x"></li>    
                            <script>
    ...
    ?> 
        ...
        <?php if ($this->uri->segment(2) == null):?>
            ...
            <script src="<?php echo base_url('assets/frontend'); ?>/js/lightbox-plus-jquery.js" type="text/javascript"></script> 
        <script src="<?php echo base_url('assets/frontend'); ?>/js/lightbox-plus-jquery.min.js" type="text/javascript"></script>      
