									...
									<tbody>
										...
										foreach ($_get_testimoni as $row):?>
											<tr>
												...
												<?php echo anchor('testimoni/delete/'.$row->id_testimoni, '<button type="button" class="btn btn-danger btn-circle waves-effect waves-circle waves-float">
