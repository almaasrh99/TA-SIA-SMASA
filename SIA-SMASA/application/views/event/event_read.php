   ...
   <section class="content">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Berikut ini adalah detail data dari event <?php echo humanize($nama_event); ?>
                            </h2>
                            <!-- <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><?php echo anchor(site_url('event/create'), 'Tambah Data'); ?></li>
                                    </ul>
                                </li>
                            </ul> -->
                        </div>
    ...
    ?>
                                        <a href="<?php echo site_url('event/list_admin'); ?>" class="btn btn-flat btn-default">Kembali</a>
                                    <?php
}?>
