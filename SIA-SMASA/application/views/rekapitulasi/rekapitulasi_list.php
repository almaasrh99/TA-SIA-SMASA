                                ...
                                <table class="table table-bordered table-striped table-hover js-exportable dataTable">
                                    ...
                                    <tbody>
										...
										foreach ($get_all as $row) :?>
											...
											<td><?php echo htmlspecialchars($row->tempat_lahir, ENT_QUOTES, 'UTF-8'); ?>, <?php echo indonesian_date( $row->tanggal_lahir); ?></td>
											...
											<td>
											<?php echo anchor('rekapitulasi/detail/'.$row->id_user, '<button type="button" class="btn btn-primary btn-circle waves-effect waves-circle waves-float">
