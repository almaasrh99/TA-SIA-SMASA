            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Berikut ini adalah detail data dari lowongan <?php echo humanize($nama_perusahaan); ?>
                            </h2>
                            <!-- <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><?php echo anchor(site_url('lowongan/create'), 'Tambah Data'); ?></li>
                                    </ul>
                                </li>
                            </ul> -->
                        </div>
                        <div class="body table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td><b>Deskripsi</b></td><td><?php echo $deskripsi; ?></td>
                                </tr>
                                <tr>
